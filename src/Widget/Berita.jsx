...
const Berita = () => {
  return (
    <div className="pt-12">
      ...
      <div className="flex flex-row justify-center items-start scale-90">
          ...
          <div className="border rounded-lg overflow-hidden shadow-lg">
            ...
            <div className="p-4">
              ...
              <p className="text-gray-700 text-base">
                ...
                corrupti itaque ducimus ipsam atque possimus officiis assumenda
                facilis reprehenderit animi, magni libero beatae ad? Expedita
                unde ex tempore accusantium? Aspernatur?
              </p>
            </div>
          </div>
        </div>
